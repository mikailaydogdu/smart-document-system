    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_id', models.IntegerField(blank=True, choices=[(1, 'x')], null=True, verbose_name='Dosta Türü')),
                ('title', models.CharField(max_length=36, verbose_name='Döküman Başlık')),
                ('doc', models.FileField(upload_to='', verbose_name='Dokumanlarım')),
                ...
                ('hash', models.CharField(blank=True, max_length=64, null=True, verbose_name='document_hash')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_sha1', models.CharField(max_length=40)),
